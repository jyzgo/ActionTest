...
namespace CocosSharp
{
    ...
    public class CCTintBy : CCFiniteTimeAction
    {
        ...
        public CCTintBy (float duration, float deltaRed, float deltaGreen, float deltaBlue) : base (duration)
        {
            DeltaR = deltaRed;
            DeltaG = deltaGreen;
            DeltaB = deltaBlue;
        ...
        {
            return new CCTintBy (Duration, (float)-DeltaR, (float)-DeltaG, (float)-DeltaB);
        }
    }
